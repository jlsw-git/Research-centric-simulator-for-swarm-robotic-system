...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        Button Events
        """
        # startPushButton Start Video Recording Event
        self.startPushButton.clicked.connect(self.startRecord)

        # stopPushButton Stop Video Recording Event
        ...
        # algorithmToolButton Select Algorithm from System Files Event
        self.algorithmToolButton.clicked.connect(self.selectAlgorithm)

        # dropFrame Accept Algorithm File Drops Event
    ...
    # Start recording current screen
    def startRecord(self):
        ...
        # Create incrementing new file name
        counter = 0
